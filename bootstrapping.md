...
<img src="bootstrapping_files/figure-gfm/unnamed-chunk-4-2.png" width="90%" />
...
boot_sample = function(df) {
  ...
  sample_frac(df, size = 1, replace = TRUE) # replace = true; give me a different sample everytime your run it
